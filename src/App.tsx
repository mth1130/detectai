...
const T:any={
  fr:{detector:"Détecteur",history:"Historique",settings:"Paramètres",title:"DetectAI Omega",sub:"Texte • Vidéo • Doc • Classe (Batch)",text:"Texte",video:"Vidéo",doc:"Document",batch:"Classe",file:"Fichier",link:"Lien",phText:"Colle ton texte d'examen ici...",phLink:"https://tiktok.com/...",launch:"Lancer l'analyse",analyzing:"Analyse...",verdict:"Verdict Final",why:"Rapport détaillé",back:"Retour",appearance:"Apparence",dark:"Sombre",light:"Clair",language:"Langue",saved:"Change!",minChar:"30 carac min",chooseVid:"Choisis vidéo",pasteLink:"Colle lien",scoreHigh:"IA Très Probable",scoreMid:"Probablement IA",scoreLow:"Humain Probable",clearHist:"Vider",noHist:"Aucune analyse",view:"Voir",analyses:"analyses",evidence:"Preuve",tech:"Tech",impact:"Poids",humanize:"Humaniser (formel)",humanize2:"Humaniser (casual)",copy:"Copier",download:"Certificat PDF",uploadDoc:"Glisse PDF, DOCX, TXT ici",docSupport:"PDF, DOCX, TXT 10Mo max",certTitle:"Certificat DetectAI",verified:"Vérifié le",hash:"Hash",scoreIA:"Score IA",status:"Statut",batchTitle:"Mode Classe - 30 devoirs d'un coup",batchDesc:"Glisse 30 fichiers TXT ici (noms des élèves)",batchBtn:"Analyser toute la classe",batchAnalyzing:"Analyse de la classe...",exportCsv:"📊 Exporter Excel (CSV)",avgScore:"Moyenne IA",iaDetected:"IA détectés",totalFiles:"Fichiers",student:"Élève",fileName:"Fichier",result:"Résultat"},
  en:{detector:"Detector",history:"History",settings:"Settings",title:"DetectAI Omega",sub:"Text • Video • Doc • Batch Class",text:"Text",video:"Video",doc:"Doc",batch:"Class",file:"File",link:"Link",phText:"Paste exam text...",phLink:"https://tiktok.com/...",launch:"Run analysis",analyzing:"Analyzing...",verdict:"Final Verdict",why:"Detailed Report",back:"Back",appearance:"Appearance",dark:"Dark",light:"Light",language:"Language",saved:"Changed!",minChar:"30 chars",chooseVid:"Choose video",pasteLink:"Paste link",scoreHigh:"Very Likely AI",scoreMid:"Probably AI",scoreLow:"Probably Human",clearHist:"Clear",noHist:"No analysis",view:"View",analyses:"analyses",evidence:"Evidence",tech:"Tech",impact:"Weight",humanize:"Humanize (formal)",humanize2:"Humanize (casual)",copy:"Copy",download:"Certificate PDF",uploadDoc:"Drop PDF, DOCX, TXT here",docSupport:"PDF, DOCX, TXT up to 10MB",certTitle:"DetectAI Certificate",verified:"Verified on",hash:"Hash",scoreIA:"AI Score",status:"Status",batchTitle:"Batch Class Mode - 30 homeworks",batchDesc:"Drop 30 TXT files (student names)",batchBtn:"Analyze whole class",batchAnalyzing:"Analyzing class...",exportCsv:"📊 Export Excel (CSV)",avgScore:"Avg AI",iaDetected:"AI detected",totalFiles:"Files",student:"Student",fileName:"File",result:"Result"},
  es:{detector:"Detector",history:"Historial",settings:"Configuración",title:"DetectAI Omega",sub:"Texto • Video • Doc • Clase (Batch)",text:"Texto",video:"Video",doc:"Documento",batch:"Clase",file:"Archivo",link:"Enlace",phText:"Pega tu texto de examen aquí...",phLink:"https://tiktok.com/...",launch:"Iniciar análisis",analyzing:"Analizando...",verdict:"Veredicto Final",why:"Informe detallado",back:"Volver",appearance:"Apariencia",dark:"Oscuro",light:"Claro",language:"Idioma",saved:"¡Cambiado!",minChar:"30 caract min",chooseVid:"Elige video",pasteLink:"Pega enlace",scoreHigh:"Muy Probable IA",scoreMid:"Probablemente IA",scoreLow:"Humano Probable",clearHist:"Borrar",noHist:"Sin análisis",view:"Ver",analyses:"análisis",evidence:"Prueba",tech:"Técnica",impact:"Impacto",humanize:"Humanizar (formal)",humanize2:"Humanizar (casual)",copy:"Copiar",download:"Certificado PDF",uploadDoc:"Arrastra PDF, DOCX, TXT aquí",docSupport:"PDF, DOCX, TXT 10MB max",certTitle:"Certificado DetectAI",verified:"Verificado el",hash:"Hash",scoreIA:"Score IA",status:"Estado",batchTitle:"Modo Clase - 30 tareas de golpe",batchDesc:"Arrastra 30 archivos TXT aquí (nombres alumnos)",batchBtn:"Analizar toda la clase",batchAnalyzing:"Analizando clase...",exportCsv:"📊 Exportar Excel (CSV)",avgScore:"Promedio IA",iaDetected:"IA detectados",totalFiles:"Archivos",student:"Alumno",fileName:"Archivo",result:"Resultado"},
  ar:{detector:"الكاشف",history:"السجل",settings:"الإعدادات",title:"DetectAI Omega",sub:"نص • فيديو • وثيقة • فصل",text:"نص",video:"فيديو",doc:"وثيقة",batch:"فصل",file:"ملف",link:"رابط",phText:"الصق نص الامتحان هنا...",phLink:"https://tiktok.com/...",launch:"بدء التحليل",analyzing:"جاري التحليل...",verdict:"الحكم النهائي",why:"تقرير مفصل",back:"رجوع",appearance:"المظهر",dark:"داكن",light:"فاتح",language:"اللغة",saved:"تم!",minChar:"30 حرفا",chooseVid:"اختر فيديو",pasteLink:"الصق رابطا",scoreHigh:"ذكاء اصطناعي محتمل جدا",scoreMid:"ربما IA",scoreLow:"بشري محتمل",clearHist:"مسح",noHist:"لا يوجد تحليل",view:"عرض",analyses:"تحليل",evidence:"دليل",tech:"تقني",impact:"تأثير",humanize:"جعله بشري رسمي",humanize2:"جعله عامي",copy:"نسخ",download:"شهادة PDF",uploadDoc:"اسحب PDF أو DOCX أو TXT هنا",docSupport:"PDF, DOCX, TXT حتى 10MB",certTitle:"شهادة DetectAI",verified:"تم التحقق في",hash:"هاش",scoreIA:"نتيجة IA",status:"الحالة",batchTitle:"وضع الفصل - 30 واجب مرة واحدة",batchDesc:"اسحب 30 ملف TXT هنا (أسماء الطلاب)",batchBtn:"تحليل الفصل كله",batchAnalyzing:"جاري تحليل الفصل...",exportCsv:"📊 تصدير Excel",avgScore:"متوسط IA",iaDetected:"تم كشف IA",totalFiles:"ملفات",student:"طالب",fileName:"ملف",result:"نتيجة"},
};
...
function analyzeDeep(text:string,type:string,lang:string){
  ...
  if(type==="text" || type==="doc" || type==="batch"){
    const markers=["en tant que modele de langage","en tant qu'intelligence artificielle","il est important de noter","il convient de souligner","il est essentiel de souligner","il est essentiel de comprendre","dans un monde en constante evolution","en conclusion, il est important","as an ai language model"];
    let foundCount=0;
    markers.forEach(m=>{ if(lower.includes(m)) foundCount++; });
    if(foundCount>=1){
      score+=55 + (foundCount*5);
      reasons.push({title:`Signature IA x${foundCount}`,level:"CRITIQUE",color:"bg-red-600",short:`${foundCount} marqueurs IA`,detail:`Formules typiques IA`,tech:`IA`,evidence:`Marqueurs`,impact:`+${55+foundCount*5}%`});
    }
    const hasPersonal=lower.includes("je pense que")||lower.includes("a mon avis")||lower.includes("dans mon cas")||lower.includes("j'ai remarque")||lower.includes("pour moi")||lower.includes("mon pere")||lower.includes("j'ai vecu")||lower.includes("je me souviens");
    if(hasPersonal){ score-=25; reasons.push({title:"Vecu humain",level:"HUMAIN",color:"bg-emerald-500",short:"Vecu perso",detail:"IA ne peut pas inventer vecu",tech:"Perso",evidence:"Vecu",impact:"-25%"}); }
    else if(text.length>150){ score+=15; reasons.push({title:"Aucun vecu",level:"SUSPECT",color:"bg-orange-500",short:"100% theorique",detail:"Pas d'avis perso",tech:"0 perso",evidence:"0 perso",impact:"+15%"}); }
    const unique=new Set(words.map(w=>w.toLowerCase())).size; const ratio=unique/(words.length||1);
    if(ratio>0.68){ score-=8; } else if(ratio<0.52 && words.length>100){ score+=8; }
  } else { score=75; reasons.push({title:"Video",level:"CRITIQUE",color:"bg-red-500",short:"Visage lisse",detail:"CapCut IA",tech:"Lissage",evidence:"Video",impact:"+35%"}); }
...
function humanizeText(text:string, mode:string, lang:string){
  ...
  if(mode==="formal"){
    ...
    out+=" A mon avis, c'est crucial et je l'ai vecu moi-meme."; return out;
  } else { let out=text.replace(/En tant que modèle de langage,?/gi, "Franchement, "); out=out.split(/(?<=[.!?])\s+/).map((s,i)=> i%3===0? "Bah "+s.charAt(0).toLowerCase()+s.slice(1):s).join(" "); out+=" Genre, tu vois? mdr."; return out; }
}
...
export default function App(){
  ...
  const runBatch=async()=>{
    ...
    for(const f of batchFiles){
      ...
      if(txt.trim().length < 20){ alert(`⚠️ ${f.name} est vide! Ouvre-le, colle du texte et fais Ctrl+S`); setBatchLoading(false); return; }
